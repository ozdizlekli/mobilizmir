...
<header class="site">
  <div class="wrap">
    <div class="logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/mobilizmir-logo-new.jpg" alt="Mobilİzmir" style="height: 55px; width: auto; mix-blend-mode: lighten;"></a></div>
    <nav class="primary">
